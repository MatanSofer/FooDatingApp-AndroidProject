...
public class User {
    ...
    public Map<String, Object> toJson() {
        ...
        json.put(userMatchesJ, getUserMatches());
    ...
    static User fromJson(Map<String, Object> json) {
        ...
        List<String> TheUserMatches = (List<String>) json.get(userMatchesJ);
        User user = new User(name1, email1, gender1, TheUserLikes, TheUserDisLikes, TheUserMatches);
